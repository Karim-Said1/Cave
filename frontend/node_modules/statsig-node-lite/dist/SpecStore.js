...
var SpecStore = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.syncValues(true)];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4: return [4 /*yield*/, this.syncIdListsFromNetwork()];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        this.addDiagnosticsMarker('download_config_specs', 'end', {
                            step: 'network_request',
                            value: status_1 !== null && status_1 !== void 0 ? status_1 : false
                        });
                        if (error) {
                            throw error;
                        }
            ...
            this.syncTimer = (0, core_1.poll)(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.syncTimerLastActiveTime = Date.now();
                            return [4 /*yield*/, this.syncValues()];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    SpecStore.prototype.syncBootstrapValues = function (bootstrapValues) {
        var specsJSON = JSON.parse(bootstrapValues);
        return this._process(specsJSON);
    };
    SpecStore.prototype.syncValues = function (isColdStart) {
        var _a;
    ...
    SpecStore.prototype.syncIdLists = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var adapter, shouldSyncFromAdapter;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    SpecStore.prototype.syncIdListsFromDataAdapter = function () {
        return __awaiter(this, void 0, void 0, function () {
            var dataAdapter_1, adapterIdLists, lookup, tasks, _loop_1, _i, lookup_1, name_1, _a;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        _loop_1 = function (name_1) {
                            tasks.push(new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, dataAdapter_1.get(IDListUtil_1["default"].getIdListDataStoreKey(name_1))];
                                        case 1:
                                            data = (_a.sent()).result;
                                            if (!data || typeof data !== 'string') {
                                                return [2 /*return*/];
                                            }
                                            this.store.idLists[name_1] = {
                                                ids: {},
                                                readBytes: 0,
                                                url: 'bootstrap',
                                                fileID: 'bootstrap',
                                            ...
                                            IDListUtil_1["default"].updateIdList(this.store.idLists, name_1, data);
                                            resolve();
                                            return [2 /*return*/];
                                    }
                                });
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 3:
                        ...
                        this.addDiagnosticsMarker('get_id_list_sources', 'end', {
                            step: 'network_request',
                            value: status_2 !== null && status_2 !== void 0 ? status_2 : false
                        });
                    ...
                    case 5:
                        ...
                        for (_i = 0, _f = Object.entries(lookup); _i < _f.length; _i++) {
                            ...
                            newFile = fileID !== ((_c = this.store.idLists[name_2]) === null || _c === void 0 ? void 0 : _c.fileID) &&
                                newCreationTime >= oldCreationTime;
                            if ((lookup.hasOwnProperty(name_2) &&
                                !this.store.idLists.hasOwnProperty(name_2)) ||
    ...
    SpecStore.prototype.genFetchIDList = function (name, url, readSize) {
        return __awaiter(this, void 0, void 0, function () {
            var res, contentLength, length_1, _a, _b, _c, e_5;
