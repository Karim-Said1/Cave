...
var asyncify_1 = __importDefault(require("./utils/asyncify"));
...
var StatsigServer = /** @class */ (function () {
    function StatsigServer(secretKey, options) {
        ...
        this._diagnostics = new Diagnostics_1["default"]({
            logger: this._logger,
     ...
     */
    StatsigServer.prototype.initializeAsync = function (options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        return this._errorBoundary.capture(function () {
            _this._diagnostics.mark('initialize', 'overall', 'start');
            ...
            if (_this._ready === true) {
                if (options.allowReInitialize) {
                    if (options.bootstrapValues) {
                        _this._evaluator.syncBootstrapValues(options.bootstrapValues);
                    }
                    else {
                        return _this._evaluator
                            .syncStoreSpecs()
                            .then(function (_) { return _this._evaluator.syncStoreIdLists(); });
                    }
                }
            ...
            var initPromise = _this._evaluator.init()["finally"](function () {
                ...
                _this._diagnostics.mark('initialize', 'overall', 'end', undefined, 'success');
                _this._diagnostics.logDiagnostics('initialize');
            });
            if (_this._options.initTimeoutMs != null &&
                ...
                _this._pendingInitPromise = Promise.race([
                    ...
                    new Promise(function (resolve) {
                        setTimeout(function () {
                            _this._diagnostics.mark('initialize', 'overall', 'end', undefined, 'timeout');
                            _this._diagnostics.logDiagnostics('initialize');
                            _this._ready = true;
                            _this._pendingInitPromise = null;
                            resolve();
    ...
    StatsigServer.prototype.getFeatureGateSync = function (user, gateName) {
        var _this = this;
        return this._errorBoundary.capture(function () { return _this.getGateImpl(user, gateName, ExposureLogging.Enabled); }, function () { return (0, FeatureGate_1.makeEmptyFeatureGate)(gateName); });
    };
    ...
    StatsigServer.prototype.getConfigSync = function (user, configName) {
        var _this = this;
        return this._errorBoundary.capture(function () { return _this.getConfigImpl(user, configName, ExposureLogging.Enabled); }, function () { return new DynamicConfig_1["default"](configName); });
    };
    StatsigServer.prototype.getConfigWithExposureLoggingDisabledSync = function (user, configName) {
        var _this = this;
        return this._errorBoundary.capture(function () { return _this.getConfigImpl(user, configName, ExposureLogging.Disabled); }, function () { return new DynamicConfig_1["default"](configName); });
    };
    ...
    StatsigServer.prototype.getLayerWithExposureLoggingDisabledSync = function (user, layerName) {
        var _this = this;
        return this._errorBoundary.capture(function () { return _this.getLayerImpl(user, layerName, ExposureLogging.Disabled); }, function () { return new Layer_1["default"](layerName); });
    };
    ...
    StatsigServer.prototype.getClientInitializeResponse = function (user, options) {
        var _this = this;
        return this._errorBoundary.capture(function () {
            if (_this._ready !== true) {
                throw new Errors_1.StatsigUninitializedError();
            ...
            return _this._evaluator.getClientInitializeResponse(normalizedUser, options);
    ...
    StatsigServer.prototype.getLayerImpl = function (inputUser, layerName, exposureLogging) {
        ...
        var ret = this._evaluator.getLayer(user, layerName);
